...
export const mockUsers: User[] = [
  {
    ...
    profile_image_url: 'https://i.pravatar.cc/150?u=jakkrit',
  ...
  },
  {
    ...
    department: 'IT',
    subsidiary: 'PS',
    job_title: 'IT System Admin',
    work_location: 'Branch 1',
    work_phone: '02-111-2222',
    role: 'admin',
    is_active: true,
    last_login_at: new Date().toISOString(),
  ...
  },
  {
    ...
    is_active: true,
    last_login_at: new Date().toISOString(),
    profile_image_url: 'https://i.pravatar.cc/150?u=user-002',
    created_at: '2024-02-10T08:00:00Z',
    updated_at: new Date().toISOString(),
  },
  {
    id: 'user-003',
    entra_object_id: 'mock-oid-003',
    email: 'wipa@trrgroup.com',
    display_name: 'วิภา สุขใจ',
    department: 'HR',
    subsidiary: 'PS',
    role: 'user',
    is_active: true,
    last_login_at: new Date().toISOString(),
    profile_image_url: 'https://i.pravatar.cc/150?u=user-003',
    created_at: '2024-03-01T08:00:00Z',
    updated_at: new Date().toISOString(),
  },
  {
    id: 'user-004',
    entra_object_id: 'mock-oid-004',
    email: 'mana@trrgroup.com',
    display_name: 'มานะ อดทน',
    department: 'Marketing',
    subsidiary: 'TRR',
    role: 'user',
    is_active: false,
    last_login_at: '2024-05-15T08:00:00Z',
    profile_image_url: 'https://i.pravatar.cc/150?u=user-004',
...
export const mockAssets: Asset[] = [
  {
    ...
    subsidiary: 'TRRT', image_url: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=300&q=80', notes: null, is_borrowable: true, deleted_at: null,
  ...
  },
  {
    ...
    subsidiary: 'TRRT', image_url: 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?auto=format&fit=crop&w=300&q=80', notes: 'ส่งซ่อมจอมีเส้น', is_borrowable: false, deleted_at: null,
  ...
  {
    id: 'asset-006', asset_tag: 'TAG-90981-IP', name: 'iPad Air 5 (64GB, Wi-Fi)', category_id: 'cat-07',
  ...
  {
    id: 'asset-007', asset_tag: 'TAG-40221-WF', name: 'Pocket Wi-Fi Huawei 4G', category_id: 'cat-06',
  ...
  {
    id: 'asset-008', asset_tag: 'TAG-12290-CK', name: 'Logitech Presenter R500', category_id: 'cat-08',
...
export const mockBorrowRequests: BorrowRequest[] = [
  {
    ...
    extension_status: null, extension_requested_date: null, extension_reason: null,
...
export const mockActiveBorrowRequests: BorrowRequest[] = [
  {
    ...
    return_confirmed_by: null, return_condition_note: null,
    extension_status: 'pending', extension_requested_date: '2026-07-15', extension_reason: 'ของใหม่ยังไม่มาส่ง ขอใช้ต่ออีก 1 สัปดาห์',
    created_at: '2026-07-01T08:00:00Z', updated_at: '2026-07-04T09:00:00Z',
    assets: mockAssets[3],
